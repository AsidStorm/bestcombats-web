...
?>
        ...
        <H3>Заявка на регистрацию клана</H3><p>
...
//отправляем системку в чат о регистрации нового клана
systemmsg('<font color=\"#CB0000\"><b>Внимание!</b> На просторах Bestcombats Зарегестрирован новый '.$sklonka.' клан '.($_POST['abr']).' Глава '.nick7 ($_POST["owner"]).' Поздравляем.</font>');
...
<p>Итак, Вы решили зарегистрировать новый клан BestCombats.net.<br>
Но прежде чем приступить к регистрации нового клана BestCombats.net, ознакомьтесь, пожалуйста, со следующими рекомендациями:</p>
<p>Каждый клан БК является уникальным сообществом игроков BestCombats.net, поэтому недопустимо связывать его прямо или косвенно с
ныне существующими или уже распущенными кланами BestCombats.net (плагиат), как в символике или в названии клана, так и в тексте
девиза клана BestCombats.net.  Большой (герб) и маленький значок должны быть выполнены в едином стиле.</p>
<p>Требования к значкам:</p>
<ul>
...
<p>Недопустимыми в названии клана, его девизе и его значках являются:</p>
<ul>
...
<li>Так как игровой мир BestCombats.net фэнтезийный,  то название клана, его девиз и значки должны соответствовать игровому миру БК; </li>
...
<IMG SRC="/i/align_7.gif" WIDTH="12" HEIGHT="15" BORDER=0 ALT=""> нейтральный - 1200 кр.<BR>
<IMG SRC="/i/align_0.99.gif" WIDTH="12" HEIGHT="15" BORDER=0 ALT=""> светлый - 1200 кр.<BR>
<IMG SRC="/i/align_0.98.gif" WIDTH="12" HEIGHT="15" BORDER=0 ALT=""> темный - 1200 кр.<BR>
<BR>
