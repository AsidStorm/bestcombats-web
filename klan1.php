<?php
    ...
    $itemcond="and destinyinv=0 and foronetrip=0 AND `bs`=0  and ecost=0 AND `podzem`=0  AND `type`<61 and present='' and artefact=0 and honor_cost=0 and honor=0 and (clan='' or clan='$user[klan]')";

    function setrestriction($id) {
      mq("insert into effects set owner='$id', name='Запрет на вступление в кланы', time=".(time()+(1080*120)).", type=".CLANRESTRICTION);
...
<?// echo'<th><img src="http://bestcombats.net/i/misc/clans/klan_img_15.jpg" width="44" height="32"></th>
