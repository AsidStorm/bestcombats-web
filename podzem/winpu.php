<?
  ...
  if($DR) {
    ...
    If (($bot=='19' or $bot=='19.19' or  $bot=='19.19.19' or $bot=='20' or $bot=='20.20' or  $bot=='20.20.20' or $bot=='21' or $bot=='21.21' or  $bot=='21.21.21' or $bot=='22' or $bot=='22.22' or  $bot=='22.22.22' or $bot=='23' or $bot=='23.23' or  $bot=='23.23.23') and $shans3<20){
	    mysql_query("INSERT into `podzem_drop` (`item_id`,`from`,`glava_id`,`location`,`etaj`)VALUES('".mt_rand(10956,11038)."','shop','".$glav_id ."','".$hokke['location']."','".$hokke['name']."')  ");
    }
	...
	If (($bot=='24' or $bot=='24.24' or  $bot=='24.24.24' or $bot=='25' or $bot=='25.25' or  $bot=='25.25.25' or $bot=='27' or $bot=='27.27' or  $bot=='27.27.27' or $bot=='28' or $bot=='28.28' or  $bot=='28.28.28') and $shans3<20){
		mysql_query("INSERT into `podzem_drop` (`item_id`,`from`,`glava_id`,`location`,`etaj`)VALUES('".mt_rand(11039,11127)."','shop','".$glav_id ."','".$hokke['location']."','".$hokke['name']."')  ");	}	
		
	
	If (($bot=='21.21.21') and $shans3<10){
		mysql_query("INSERT into `podzem_drop` (`item_id`,`from`,`glava_id`,`location`,`etaj`)VALUES('".mt_rand(11524,11528)."','shop','".$glav_id ."','".$hokke['location']."','".$hokke['name']."')  ");	}	
	

	If (($bot=='26.26') and $shans3<30){
		mysql_query("INSERT into `podzem_drop` (`item_id`,`from`,`glava_id`,`location`,`etaj`)VALUES('".mt_rand(11320,11326)."','shop','".$glav_id ."','".$hokke['location']."','".$hokke['name']."')  ");	}	
	
	
	If (($bot=='19') and $shans3<10){
		mysql_query("INSERT into `podzem_drop` (`item_id`,`from`,`glava_id`,`location`,`etaj`)VALUES('".mt_rand(11609,11613)."','shop','".$glav_id ."','".$hokke['location']."','".$hokke['name']."')  ");
	}

	If (($bot=='26.26.26') and $shans3<25){
		mysql_query("INSERT into `podzem_drop` (`item_id`,`from`,`glava_id`,`location`,`etaj`)VALUES('".mt_rand(11437,11442)."','shop','".$glav_id ."','".$hokke['location']."','".$hokke['name']."')  ");
	}
	
	If (($bot=='19.19' or  $bot=='19.19.19' or $bot=='20' or $bot=='20.20' or  $bot=='20.20.20' or $bot=='21' or $bot=='21.21' or  $bot=='21.21.21' or $bot=='22' or $bot=='22.22' or  $bot=='22.22.22' or $bot=='23' or $bot=='23.23' or  $bot=='23.23.23' or $bot=='24' or $bot=='24.24' or  $bot=='24.24.24' or $bot=='25' or $bot=='25.25' or  $bot=='25.25.25' or $bot=='27' or $bot=='27.27' or  $bot=='27.27.27' or $bot=='28' or $bot=='28.28' or  $bot=='28.28.28') and $shans3<1){
