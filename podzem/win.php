<?
  ...
  if($DR) {
    ...
    If (($bot=='1' or $bot=='1.1' or  $bot=='1.1.1' or $bot=='2' or $bot=='2.2' or  $bot=='2.2.2' or $bot=='3' or $bot=='3.3' or  $bot=='3.3.3' or $bot=='4' or $bot=='4.4' or  $bot=='4.4.4' or $bot=='5' or $bot=='5.5' or  $bot=='5.5.5' or $bot=='6' or $bot=='6.6' or  $bot=='6.6.6') and $shans3<20){
	    db_query("INSERT into `podzem_drop` (`item_id`,`from`,`glava_id`,`location`,`etaj`)VALUES('".mt_rand(3426,3603)."','shop','".$glav_id ."','".$hokke['location']."','".$hokke['name']."')  ");
    }
	...
	If (($bot=='9' or $bot=='9.9' or  $bot=='9.9.9' or $bot=='10' or $bot=='10.10' or  $bot=='10.10.10' or $bot=='11' or $bot=='11.11' or  $bot=='11.11.11' or $bot=='12' or $bot=='12.12' or  $bot=='12.12.12' or $bot=='13' or $bot=='13.13' or  $bot=='13.13.13' or $bot=='16' or $bot=='16.16' or  $bot=='16.16.16') and $shans3<20){
		db_query("INSERT into `podzem_drop` (`item_id`,`from`,`glava_id`,`location`,`etaj`)VALUES('".mt_rand(3604,3692)."','shop','".$glav_id ."','".$hokke['location']."','".$hokke['name']."')  ");
	}
	
	If ($bot=='18' and $shans4<=50){
		db_query("INSERT into `podzem_drop` (`item_id`,`from`,`glava_id`,`location`,`etaj`)VALUES('".mt_rand(3784,3791)."','shop','".$glav_id ."','".$hokke['location']."','".$hokke['name']."')  ");
	}
	...
	If (($bot=='4' or $bot=='14.14' or  $bot=='14.14.14' or $bot=='15' or $bot=='15.15' or  $bot=='15.15.15' or $bot=='17' or $bot=='17.17' or  $bot=='17.17.17') and $shans3<20){
		db_query("INSERT into `podzem_drop` (`item_id`,`from`,`glava_id`,`location`,`etaj`)VALUES('".mt_rand(3693,3775)."','shop','".$glav_id ."','".$hokke['location']."','".$hokke['name']."')  ");
	}
	...
	If (($bot=='1' or $bot=='1.1' or  $bot=='1.1.1' or $bot=='2' or $bot=='2.2' or  $bot=='2.2.2' or $bot=='3' or $bot=='3.3' or  $bot=='3.3.3' or $bot=='4' or $bot=='4.4' or  $bot=='4.4.4' or $bot=='5' or $bot=='5.5' or  $bot=='5.5.5' or $bot=='6' or $bot=='6.6' or  $bot=='6.6.6' or  $bot=='7' or $bot=='7.7' or  $bot=='7.7.7' or $bot=='9' or $bot=='9.9' or  $bot=='9.9.9' or $bot=='10' or $bot=='10.10' or  $bot=='10.10.10' or $bot=='11' or $bot=='11.11' or  $bot=='11.11.11' or $bot=='12' or $bot=='12.12' or  $bot=='12.12.12' or $bot=='13' or $bot=='13.13' or  $bot=='13.13.13' or $bot=='14' or $bot=='15' or $bot=='16' or $bot=='17' or $bot=='18') and $shans3<1){
      ...
      if($bot=='1' or $bot=='2' or $bot=='3' or $bot=='1.1' or $bot=='1.2' or $bot=='1.3' or $bot=='2.2' or $bot=='2.3' or $bot=='3.3' or $bot=='1.1.1' or $bot=='1.1.2' or $bot=='1.1.2' or $bot=='1.2.2' or $bot=='1.3.2' or $bot=='1.3.3' or $bot=='2.2.2' or $bot=='2.2.3' or $bot=='2.3.3' or $bot=='3.3.3' or $bot=='1.3.2'){
        ...
        $est = $d1+$d2+$d3+500;
        if($est>'500'){db_query("UPDATE podzem3 SET n$nomer='$est' WHERE glava='$glava' and name='".$hokke["name"]."'");}
        else{db_query("UPDATE podzem3 SET n$nomer='' WHERE glava='$glava' and name='".$hokke["name"]."'");}
      }
      ...
      if($est=='510'){db_query("UPDATE podzem3 SET n$nomer='$est' WHERE glava='$glava' and name='".$hokke["name"]."'");}
      else{db_query("UPDATE podzem3 SET n$nomer='' WHERE glava='$glava' and name='".$hokke["name"]."'");}
      if($this->user['medal2']=='0'){db_query("UPDATE `users` SET `medal2`='1' WHERE `id`=".$this->user['id']."");}
      }
      //////////////////////////2 etaz//////////////////////////////
      ...
      $est = $d1+$d2+$d3+600;
      if($est>'600'){db_query("UPDATE podzem3 SET n$nomer='$est' WHERE glava='$glava' and name='".$hokke["name"]."'");}
      else{db_query("UPDATE podzem3 SET n$nomer='' WHERE glava='$glava' and name='".$hokke["name"]."'");}
      ...
      $est = $d1+$d2+$d3+603;
      if($est>'603'){db_query("UPDATE podzem3 SET n$nomer='$est' WHERE glava='$glava' and name='".$hokke["name"]."'");}
      else{db_query("UPDATE podzem3 SET n$nomer='' WHERE glava='$glava' and name='".$hokke["name"]."'");}
      ...
      $est = $d1+$d2+$d3+606;
      if($est>'606'){db_query("UPDATE podzem3 SET n$nomer='$est' WHERE glava='$glava' and name='".$hokke["name"]."'");}
      else{db_query("UPDATE podzem3 SET n$nomer='' WHERE glava='$glava' and name='".$hokke["name"]."'");}
      ...
      $est = $d1+$d2+$d3+609;
      if($est>'609'){db_query("UPDATE podzem3 SET n$nomer='$est' WHERE glava='$glava' and name='".$hokke["name"]."'");}
      else{db_query("UPDATE podzem3 SET n$nomer='' WHERE glava='$glava' and name='".$hokke["name"]."'");}
      ...
      if($bot=='14' or $bot=='14.14' or $bot=='14.14.14' or $bot=='17' or $bot=='17.17' or $bot=='17.17.17' or $bot=='18' or $bot=='18.18' or $bot=='18.18.18'){
        ...
        $est = $d1+$d2+$d3+612;
        if($est>'612'){db_query("UPDATE podzem3 SET n$nomer='$est' WHERE glava='$glava' and name='".$hokke["name"]."'");}
        else{db_query("UPDATE podzem3 SET n$nomer='' WHERE glava='$glava' and name='".$hokke["name"]."'");}
      }//////////Рабочий винтель/////////////////
    } elseif ($this->user["room"]==48) {
      if ($bot=="29") {
        if (rand(0,100)<=50) db_query("UPDATE podzem3 SET n$nomer='511' WHERE glava='$glava' and name='".$hokke["name"]."'");
        else db_query("UPDATE podzem3 SET n$nomer='' WHERE glava='$glava' and name='".$hokke["name"]."'");
      }
      if ($bot=="30") {
        if (rand(0,100)<=75) db_query("UPDATE podzem3 SET n$nomer='511' WHERE glava='$glava' and name='".$hokke["name"]."'");
        else db_query("UPDATE podzem3 SET n$nomer='' WHERE glava='$glava' and name='".$hokke["name"]."'");
      }
      if ($bot=="31") {
        if (rand(0,100)<=100) db_query("UPDATE podzem3 SET n$nomer='511' WHERE glava='$glava' and name='".$hokke["name"]."'");
        else db_query("UPDATE podzem3 SET n$nomer='' WHERE glava='$glava' and name='".$hokke["name"]."'");
      }
    } else {
      $bots=explode(".",$bot);
    ...
    $bots=explode(".", $bot);
    foreach ($bots as $k=>$v) {
      if ($v) db_query("update podzem_zad_login set ubil=ubil+1 where owner='$maxdamageuser' and bot='$v' and ubil<ubit");
    }
  }
