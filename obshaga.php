...
// положить шмотку
if($_GET['add']) {
    $it = mqfa("SELECT * FROM `inventory` WHERE `dressed`=0 AND `setsale` = 0 AND `onlyone` = 0 AND `owner` =".$user['id']." AND `id` = ".$_GET['add']." and (dategoden=0 or (gift=1 and dategoden>".time()."))");
    if($it['owner'] ==$user['id']) {
      if ($it["gift"]==1) {
        $cnt=$skoka_p;
        $max=$podarok;
...
//Зашли без аренды
if (!$obshaga || ($obshaga && @$_GET["changearenda"]) || ((!$obshaga["etaz"] || ($_REQUEST['etaz'] == "" && $obshaga['etaz'] == 0 && $_REQUEST['room']=="" && $_REQUEST['add']=="" && $_REQUEST['back']=="") || ($_GET['etaz'] == "1" && $obshaga['arenda']=="" && $_GET['room']=="") || $user['vip']==3 && ($_GET['etaz']=="0" || $obshaga['arenda']==4) && $_GET['etaz'] !=4 && $_REQUEST['room'] == "") && $obshaga["balanse"]>=0)) {
?>
<HTML><HEAD>
...
<td bgcolor="#D3D3D3" nowrap><a href="city.php?strah=1" onClick="return check_access();" class="menutop" title="Время перехода: 10 сек."><? echo $rooms[21]; ?></a></td>
</tr>
<? if($user['vip']!=3){?>
<tr>
<td bgcolor="#D3D3D3"><img src="<?=IMGBASE?>/i/move/links.gif" width="9" height="7" /></td>
...
if (!@$_GET["changearenda"] && (($obshaga['etaz']>0 && $_GET['etaz'] == "" && $_GET['room'] == "" && $user['vip']!="3") || ($obshaga["etaz"] && $_GET['etaz'] == "0" && $user['vip']!=3) || $obshaga['balanse']<0 && $user['vip']!="3")) {
?>
...
if($mess!="")
    echo $mess."<br>";
if($_GET['etaz']=="4" && $user['vip']=="3" && $user['room']=="104" || $_GET['room']=="7" && $user['vip']=="3" && $user['room']=="104")
{
...
//Комната
if(($_GET['room']=="1" && $obshaga['etaz']=="1" && $user['room']=="101" || $_GET['room']=="1" && $obshaga['etaz']=="2" && $user['room']=="102" || $_GET['room']=="1" && $obshaga['etaz']=="3" && $user['room']=="103") || ($_GET['etaz']=="1" && $obshaga['etaz']=="1" && $user['room']=="101" && !@$_GET['room'] || $_GET['etaz']=="2" && $obshaga['etaz']=="2" && $user['room']=="102" && !@$_GET['room'] || $_GET['etaz']=="3" && $obshaga['etaz']=="3" && $user['room']=="103" && !@$_GET['room']) || $_GET['room']=="1" && $user['vip']=="3" && $user['room']=="104") {
?>
...
<? }
//Сундук
if($_GET['room']=="2" && $user['room']=="101" && $obshaga['etaz'] == "1" ||  $_GET['room']=="2" && $user['room']=="102" && $obshaga['etaz'] == "2" || $_GET['room']=="2" && $user['room']=="103" && $obshaga['etaz'] == "3" || $_GET['room']=="2" && $user['room']=="104" && $user['vip'] == "3") {
?>
...
//Сувениры
if($_GET['room']=="6" && $user['room']=="101" && $obshaga['etaz'] == "1" ||  $_GET['room']=="6" && $user['room']=="102" && $obshaga['etaz'] == "2" || $_GET['room']=="6" && $user['room']=="103" && $obshaga['etaz'] == "3" || $_GET['room']=="6" && $user['room']=="104" && $user['vip'] == "3") {
?>
...
if($_GET['room']=="8" && $user['room']=="102" && $obshaga['etaz'] == "2" || $_GET['room']=="8" && $user['room']=="103" && $obshaga['etaz'] == "3" || $_GET['room']=="8" && $user['room']=="104" && $user['vip'] == "3") {
?>
...
//Сон
if($_GET['room']=="4" && $user['room']=="101" && $obshaga['etaz'] == "1" && $obshaga['sleep'] == "0" ||  $_GET['room']=="4" && $user['room']=="102" && $obshaga['etaz'] == "2" && $obshaga['sleep'] == "0" || $_GET['room']=="4" && $user['room']=="103" && $obshaga['etaz'] == "3" && $obshaga['sleep'] == "0" || $_GET['room']=="4" && $user['room']=="104" && $user['vip'] == "3" && $obshaga['sleep'] == "0") {
?>
<table>
<tr><td valign="top">
...
<? }
if($_GET['room']=="4" && $user['room']=="101" && $obshaga['etaz'] == "1" && $obshaga['sleep'] ||  $_GET['room']=="4" && $user['room']=="102" && $obshaga['etaz'] == "2" && $obshaga['sleep'] || $_GET['room']=="4" && $user['room']=="103" && $obshaga['etaz'] == "3" && $obshaga['sleep'] || $_GET['room']=="4" && $user['room']=="104" && $user['vip'] == "3" && $obshaga['sleep'])  {
?>
Вы можете заснуть, забыв о внешнем мире.<BR>
...
Деньги: <? echo $user['money'] ?> кр.<BR><BR>
<?
if($_GET['room']=="7" && $user['vip'] == "3" && $user['room']=="104" || $_GET['etaz']=="4" && $user['vip'] == "3" && $user['room']=="104")
{
...
if($_GET['room']=="2" && $obshaga['etaz'] == "1" && $user['room']=="101" || $_GET['room']=="2" && $obshaga['etaz'] == "2" && $user['room']=="102" || $_GET['room']=="2" && $obshaga['etaz'] == "3" && $user['room']=="103" || $_GET['room']=="2" && $user['vip'] == "3" && $user['room']=="104")
{
if($user['vip']==3) echo "<A href=/obshaga.php?room=7>Прихожая</a><BR>";
    echo "<A href=/obshaga.php?room=1>Комната</A><BR>";
    echo "<b>Сундук</b><BR>";
    echo "<A href=/obshaga.php?room=6>Сувениры</A><BR>";
        echo "<A href=/obshaga.php?room=4>Койка</A><BR>";
...
if($_GET['room']=="6" && $obshaga['etaz'] == "1" && $user['room']=="101" || $_GET['room']=="6" && $obshaga['etaz'] == "2" && $user['room']=="102" || $_GET['room']=="6" && $obshaga['etaz'] == "3" && $user['room']=="103" || $_GET['room']=="6" && $user['vip'] == "3" && $user['room']=="104") {
  if($user['vip']==3) echo "<A href=/obshaga.php?room=7>Прихожая</a><BR>";
  echo "<A href=/obshaga.php?room=1>Комната</A><BR>";
  echo "<A href=/obshaga.php?room=2>Сундук</A><BR>";
...
if($_GET['room']=="4" && $obshaga['etaz'] == "1" && $user['room']=="101" || $_GET['room']=="4" && $obshaga['etaz'] == "2" && $user['room']=="102" || $_GET['room']=="4" && $obshaga['etaz'] == "3" && $user['room']=="103" || $_GET['room']=="4" && $user['vip'] == "3" && $user['room']=="104") {
  if($user['vip']==3) echo "<A href=/obshaga.php?room=7>Прихожая</a><BR>";
  echo "<A href=/obshaga.php?room=1>Комната</A><BR>";
  echo "<A href=/obshaga.php?room=2>Сундук</A><BR>";
  echo "<A href=/obshaga.php?room=6>Сувениры</A><BR>";
...
if($_GET['room']=="8" && $obshaga['etaz'] == "1" && $user['room']=="101" || $_GET['room']=="8" && $obshaga['etaz'] == "2" && $user['room']=="102" || $_GET['room']=="8" && $obshaga['etaz'] == "3" && $user['room']=="103" || $_GET['room']=="8" && $user['vip'] == "3" && $user['room']=="104") {
  if($user['vip']==3) echo "<A href=/obshaga.php?room=7>Прихожая</a><BR>";
  echo "<A href=/obshaga.php?room=1>Комната</A><BR>";
  echo "<A href=/obshaga.php?room=2>Сундук</A><BR>";
  echo "<A href=/obshaga.php?room=6>Сувениры</A><BR>";
