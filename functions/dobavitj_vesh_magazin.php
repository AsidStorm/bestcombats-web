...
?>
<form method=post action="dobavitj_vesh_magazin.php">
<b>Вещи</b>
<table>
...
<tr><td>Тип предмета 
			...
			<option value="3">Орудия труда</option>
	</select> </td></tr>
...
<tr><td>Может чиниться ли</td><td><input type=text name=isrep value="1"> </td></tr>
<tr><td>Раздел магазина 
			...
			<option value="50">Еда</option>
			<option value="52">Орудия труда</option>
	</select> </td></tr>
...
<tr><td>Цена (кр)  </td><td><input type=text name=cost  value="0"></td></tr>
<tr><td>Срок годности (дни)  </td><td><input type=text name=goden  value="0"></td></tr>
<tr><td>Подарок ли  </td><td><input type=text name=gift  value="0"></td></tr>
<tr><td>Номер магазина  </td><td><input type=text name=shop  value="0"></td></tr>
<tr><td>Можно ли купить за деньги  </td><td><input type=text name=buyformoney  value="0"></td></tr>
</table>
<b>Требования:</b>
<table>
