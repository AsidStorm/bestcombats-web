<?
  function wake($userid) {
    ...
    $r = mysql_query("SELECT * FROM `obshagaeffects` WHERE owner = '$userid'");
    while ($it=mysql_fetch_array($r)) {
      ...
      mysql_query("INSERT INTO `effects` (`id`, `type`, `name`, `time`, `sila`, `lovk`, `inta`, `vinos`, `intel`, `mudra`, mf, mfval, mfdmag, mfdhit, `owner`, `lastup`, `stihiya`, ghp, gmana, hpforvinos,  mfdkol, mfdrub, mfdrej, mfddrob, mfdfire, mfdwater, mfdair, mfdearth) 
