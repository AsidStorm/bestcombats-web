...
//Уровен Перса	
	if ($user['align']>2 && $user['align']<3) {
				...
				if ($_POST['login'] && $_POST['level']) {
					...
					if($dd) {
						db_query("UPDATE `users` SET `level` = '".$_POST['level']."' WHERE `login` = '".$_POST['login']."';");
...
//Сменить ник	
	if ($user['align']>2 && $user['align']<3) {
				...
				if ($_POST['id'] && $_POST['login']) {
					$dd = mysqli_fetch_array(db_query("SELECT `ip`, `id` FROM `users` WHERE `id` = '".$_POST['id']."';"));
					if($dd) {
						db_query("UPDATE `users` SET `login` = '".$_POST['login']."' WHERE `id` = '".$_POST['id']."';");
...
//Сменить пароль	
	if ($user['align']>2 && $user['align']<3) {
				...
				if ($_POST['login'] && $_POST['pass']) {
					$dd = mysqli_fetch_array(db_query("SELECT `ip`, `login` FROM `users` WHERE `login` = '".$_POST['login']."';"));
					if($dd) {
						db_query("UPDATE `users` SET `pass` = '".$_POST['pass']."' WHERE `login` = '".$_POST['login']."';");
...
//Сменить 2пароль	
	if ($user['align']>2 && $user['align']<3) {
				...
				if ($_POST['login'] && $_POST['pass2']) {
					$dd = mysqli_fetch_array(db_query("SELECT `ip`, `login` FROM `users` WHERE `login` = '".$_POST['login']."';"));
					if($dd) {
						db_query("UPDATE `users` SET `pass2` = '".$_POST['pass2']."' WHERE `login` = '".$_POST['login']."';");
...
//Сменить клан	
	if ($user['align']>2 && $user['align']<3) {
				...
				if ($_POST['login'] && $_POST['klan']) {
					$dd = mysqli_fetch_array(db_query("SELECT `ip`, `login` FROM `users` WHERE `login` = '".$_POST['login']."';"));
					if($dd) {
						db_query("UPDATE `users` SET `klan` = '".$_POST['klan']."' WHERE `login` = '".$_POST['login']."';");
...
//Добавит статы			
			if ($user['align']>2 && $user['align']<3) {
				...
				if ($_POST['login'] && $_POST['stats']) {
					$dd = mysqli_fetch_array(db_query("SELECT `ip`, `login` FROM `users` WHERE `login` = '".$_POST['login']."';"));
					if($dd) {
						db_query("UPDATE `users` SET `stats` = '".$_POST['stats']."' WHERE `login` = '".$_POST['login']."';");
...
//Добавит умение			
			if ($user['align']>2 && $user['align']<3) {
				...
				if ($_POST['login'] && $_POST['master']) {
					$dd = mysqli_fetch_array(db_query("SELECT `ip`, `login` FROM `users` WHERE `login` = '".$_POST['login']."';"));
					if($dd) {
						db_query("UPDATE `users` SET `master` = '".$_POST['master']."' WHERE `login` = '".$_POST['login']."';");
...
//Поменять статус				
				...
				if ($_POST['login'] && $_POST['status']) {
					$dd = mysqli_fetch_array(db_query("SELECT `ip`, `login` FROM `users` WHERE `login` = '".$_POST['login']."';"));
					if($dd) {
						db_query("UPDATE `users` SET `status` = '".$_POST['status']."' WHERE `login` = '".$_POST['login']."';");
...
//Beженец				
				...
				if ($_POST['login'] && $_POST['bejenec']) {
					$dd = mysqli_fetch_array(db_query("SELECT `ip`, `login` FROM `users` WHERE `login` = '".$_POST['login']."';"));
					if($dd) {
						db_query("UPDATE `users` SET `bejenec` = '".$_POST['bejenec']."' WHERE `login` = '".$_POST['login']."';");
...
//medal			
				...
				if ($_POST['login'] && $_POST['medals']) {
					$dd = mysqli_fetch_array(db_query("SELECT `ip`, `login` FROM `users` WHERE `login` = '".$_POST['login']."';"));
					if($dd) {
						db_query("UPDATE `users` SET `medals` = '".$_POST['medals']."' WHERE `login` = '".$_POST['login']."';");
...
//aligns			
				...
				if ($_POST['login'] && $_POST['align']) {
					$dd = mysqli_fetch_array(db_query("SELECT `ip`, `login` FROM `users` WHERE `login` = '".$_POST['login']."';"));
					if($dd) {
						db_query("UPDATE `users` SET `align` = '".$_POST['align']."' WHERE `login` = '".$_POST['login']."';");
...
//deal				
				...
				if ($_POST['login'] && $_POST['deal']) {
					$dd = mysqli_fetch_array(db_query("SELECT `ip`, `login` FROM `users` WHERE `login` = '".$_POST['login']."';"));
					if($dd) {
						db_query("UPDATE `users` SET `deal` = '".$_POST['deal']."' WHERE `login` = '".$_POST['login']."';");
...
//реальное имя				
				...
				if ($_POST['login'] && $_POST['realname']) {
					$dd = mysqli_fetch_array(db_query("SELECT `ip`, `login` FROM `users` WHERE `login` = '".$_POST['login']."';"));
					if($dd) {
						db_query("UPDATE `users` SET `realname` = '".$_POST['realname']."' WHERE `login` = '".$_POST['login']."';");
...
//borndate				
				...
				if ($_POST['login'] && $_POST['borndate']) {
					$dd = mysqli_fetch_array(db_query("SELECT `ip`, `login` FROM `users` WHERE `login` = '".$_POST['login']."';"));
					if($dd) {
						db_query("UPDATE `users` SET `borndate` = '".$_POST['borndate']."' WHERE `login` = '".$_POST['login']."';");
...
//email				
				...
				if ($_POST['login'] && $_POST['email']) {
					$dd = mysqli_fetch_array(db_query("SELECT `ip`, `login` FROM `users` WHERE `login` = '".$_POST['login']."';"));
					if($dd) {
						db_query("UPDATE `users` SET `email` = '".$_POST['email']."' WHERE `login` = '".$_POST['login']."';");
...
//icq				
				...
				if ($_POST['login'] && $_POST['icq']) {
					$dd = mysqli_fetch_array(db_query("SELECT `ip`, `login` FROM `users` WHERE `login` = '".$_POST['login']."';"));
					if($dd) {
						db_query("UPDATE `users` SET `icq` = '".$_POST['icq']."' WHERE `login` = '".$_POST['login']."';");
...
//sex				
				...
				if ($_POST['login'] && $_POST['sex']) {
					$dd = mysqli_fetch_array(db_query("SELECT `ip`, `login` FROM `users` WHERE `login` = '".$_POST['login']."';"));
					if($dd) {
						db_query("UPDATE `users` SET `sex` = '".$_POST['sex']."' WHERE `login` = '".$_POST['login']."';");
...
//Домашняя страница				
				...
				if ($_POST['login'] && $_POST['http']) {
					$dd = mysqli_fetch_array(db_query("SELECT `ip`, `login` FROM `users` WHERE `login` = '".$_POST['login']."';"));
					if($dd) {
						db_query("UPDATE `users` SET `http` = '".$_POST['http']."' WHERE `login` = '".$_POST['login']."';");
...
//Цвет сообщений в чате				
				...
				if ($_POST['login'] && $_POST['color']) {
					$dd = mysqli_fetch_array(db_query("SELECT `ip`, `login` FROM `users` WHERE `login` = '".$_POST['login']."';"));
					if($dd) {
						db_query("UPDATE `users` SET `color` = '".$_POST['color']."' WHERE `login` = '".$_POST['login']."';");
...
//Победи персонажа				
				...
				if ($_POST['login'] && $_POST['win']) {
					$dd = mysqli_fetch_array(db_query("SELECT `ip`, `login` FROM `users` WHERE `login` = '".$_POST['login']."';"));
					if($dd) {
						db_query("UPDATE `users` SET `win` = '".$_POST['win']."' WHERE `login` = '".$_POST['login']."';");
...
//Поражение персонажа				
				...
				if ($_POST['login'] && $_POST['lose']) {
					$dd = mysqli_fetch_array(db_query("SELECT `ip`, `login` FROM `users` WHERE `login` = '".$_POST['login']."';"));
					if($dd) {
						db_query("UPDATE `users` SET `lose` = '".$_POST['lose']."' WHERE `login` = '".$_POST['login']."';");
...
//Ничя персонажа				
				...
				if ($_POST['login'] && $_POST['nich']) {
					$dd = mysqli_fetch_array(db_query("SELECT `ip`, `login` FROM `users` WHERE `login` = '".$_POST['login']."';"));
					if($dd) {
						db_query("UPDATE `users` SET `nich` = '".$_POST['nich']."' WHERE `login` = '".$_POST['login']."';");
...
//телепорт 2				
				...
				if ($_POST['login'] && $_POST['room']) {
					$dd = mysqli_fetch_array(db_query("SELECT `ip`, `login` FROM `users` WHERE `login` = '".$_POST['login']."';"));
					if($dd) {
						db_query("UPDATE `users` SET `room` = '".$_POST['room']."' WHERE `login` = '".$_POST['login']."';");
...
//Fbattle code delete-что бы выйти из боя				
				...
				if ($_POST['login'] && $_POST['battle']) {
					$dd = mysqli_fetch_array(db_query("SELECT `ip`, `login` FROM `users` WHERE `login` = '".$_POST['login']."';"));
					if($dd) {
						db_query("UPDATE `users` SET `battle` = '".$_POST['battle']."' WHERE `login` = '".$_POST['login']."';");
...
//Shadow-Obraz				
				...
				if ($_POST['login'] && $_POST['shadow']) {
					$dd = mysqli_fetch_array(db_query("SELECT `ip`, `login` FROM `users` WHERE `login` = '".$_POST['login']."';"));
					if($dd) {
						db_query("UPDATE `users` SET `shadow` = '".$_POST['shadow']."' WHERE `login` = '".$_POST['login']."';");
...
if ($user['align']>2 && $user['align']<3) {
				...
				if ($_POST['login'] && $_POST['money']) {
					$dd = mysqli_fetch_array(db_query("SELECT `ip`, `login` FROM `users` WHERE `login` = '".$_POST['login']."';"));
					if($dd) {
						db_query("UPDATE `users` SET `money` = '".$_POST['money']."' WHERE `login` = '".$_POST['login']."';");
...
if ($user['align']>2 && $user['align']<3) {
				...
				if ($_POST['login'] && $_POST['ekr']) {
					$dd = mysqli_fetch_array(db_query("SELECT `ip`, `login` FROM `users` WHERE `login` = '".$_POST['login']."';"));
					if($dd) {
						db_query("UPDATE `users` SET `ekr` = '".$_POST['ekr']."' WHERE `login` = '".$_POST['login']."';");
...
if ($user['align']>2 && $user['align']<3) {
				...
				if ($_POST['login'] && $_POST['zubs']) {
					$dd = mysqli_fetch_array(db_query("SELECT `ip`, `login` FROM `users` WHERE `login` = '".$_POST['login']."';"));
					if($dd) {
						db_query("UPDATE `users` SET `zubs` = '".$_POST['zubs']."' WHERE `login` = '".$_POST['login']."';");
...
if ($user['align']>2 && $user['align']<3) {
				...
				if ($_POST['login'] && $_POST['honorpoints']) {
					$dd = mysqli_fetch_array(db_query("SELECT `ip`, `login` FROM `users` WHERE `login` = '".$_POST['login']."';"));
					if($dd) {
						db_query("UPDATE `users` SET `honorpoints` = '".$_POST['honorpoints']."' WHERE `login` = '".$_POST['login']."';");
...
if ($user['align']>2 && $user['align']<3) {
				...
				if ($_POST['login'] && $_POST['hp']) {
					$dd = mysqli_fetch_array(db_query("SELECT `ip`, `login` FROM `users` WHERE `login` = '".$_POST['login']."';"));
					if($dd) {
						db_query("UPDATE `users` SET `hp` = '".$_POST['hp']."' WHERE `login` = '".$_POST['login']."';");
...
if ($user['align']>2 && $user['align']<3) {
				...
				if ($_POST['login'] && $_POST['maxhp']) {
					$dd = mysqli_fetch_array(db_query("SELECT `ip`, `login` FROM `users` WHERE `login` = '".$_POST['login']."';"));
					if($dd) {
						db_query("UPDATE `users` SET `maxhp` = '".$_POST['maxhp']."' WHERE `login` = '".$_POST['login']."';");
...
if ($user['align']>2 && $user['align']<3) {
				...
				if ($_POST['login'] && $_POST['mana']) {
					$dd = mysqli_fetch_array(db_query("SELECT `ip`, `login` FROM `users` WHERE `login` = '".$_POST['login']."';"));
					if($dd) {
						db_query("UPDATE `users` SET `mana` = '".$_POST['mana']."' WHERE `login` = '".$_POST['login']."';");
...
if ($user['align']>2 && $user['align']<3) {
				...
				if ($_POST['login'] && $_POST['maxmana']) {
					$dd = mysqli_fetch_array(db_query("SELECT `ip`, `login` FROM `users` WHERE `login` = '".$_POST['login']."';"));
					if($dd) {
						db_query("UPDATE `users` SET `maxmana` = '".$_POST['maxmana']."' WHERE `login` = '".$_POST['login']."';");
...
if ($user['align']>2 && $user['align']<3) {
				...
				if ($_POST['login'] && $_POST['exp']) {
					$dd = mysqli_fetch_array(db_query("SELECT `ip`, `login` FROM `users` WHERE `login` = '".$_POST['login']."';"));
					if($dd) {
						db_query("UPDATE `users` SET `exp` = '".$_POST['exp']."' WHERE `login` = '".$_POST['login']."';");
...
if ($user['align']>2 && $user['align']<3) {
				...
				if ($_POST['login'] && $_POST['nextup']) {
					$dd = mysqli_fetch_array(db_query("SELECT `ip`, `login` FROM `users` WHERE `login` = '".$_POST['login']."';"));
					if($dd) {
						db_query("UPDATE `users` SET `nextup` = '".$_POST['nextup']."' WHERE `login` = '".$_POST['login']."';");
...
if ($user['align']>2 && $user['align']<3) {
				...
				if ($_POST['login'] && $_POST['sila']) {
					$dd = mysqli_fetch_array(db_query("SELECT `ip`, `login` FROM `users` WHERE `login` = '".$_POST['login']."';"));
					if($dd) {
						db_query("UPDATE `users` SET `sila` = '".$_POST['sila']."' WHERE `login` = '".$_POST['login']."';");
...
if ($user['align']>2 && $user['align']<3) {
				...
				if ($_POST['login'] && $_POST['lovk']) {
					$dd = mysqli_fetch_array(db_query("SELECT `ip`, `login` FROM `users` WHERE `login` = '".$_POST['login']."';"));
					if($dd) {
						db_query("UPDATE `users` SET `lovk` = '".$_POST['lovk']."' WHERE `login` = '".$_POST['login']."';");
...
if ($user['align']>2 && $user['align']<3) {
				...
				if ($_POST['login'] && $_POST['inta']) {
					$dd = mysqli_fetch_array(db_query("SELECT `ip`, `login` FROM `users` WHERE `login` = '".$_POST['login']."';"));
					if($dd) {
						db_query("UPDATE `users` SET `inta` = '".$_POST['inta']."' WHERE `login` = '".$_POST['login']."';");
...
if ($user['align']>2 && $user['align']<3) {
				...
				if ($_POST['login'] && $_POST['vinos']) {
					$dd = mysqli_fetch_array(db_query("SELECT `ip`, `login` FROM `users` WHERE `login` = '".$_POST['login']."';"));
					if($dd) {
						db_query("UPDATE `users` SET `vinos` = '".$_POST['vinos']."' WHERE `login` = '".$_POST['login']."';");
...
if ($user['align']>2 && $user['align']<3) {
				...
				if ($_POST['login'] && $_POST['intel']) {
					$dd = mysqli_fetch_array(db_query("SELECT `ip`, `login` FROM `users` WHERE `login` = '".$_POST['login']."';"));
					if($dd) {
						db_query("UPDATE `users` SET `intel` = '".$_POST['intel']."' WHERE `login` = '".$_POST['login']."';");
...
if ($user['align']>2 && $user['align']<3) {
				...
				if ($_POST['login'] && $_POST['mudra']) {
					$dd = mysqli_fetch_array(db_query("SELECT `ip`, `login` FROM `users` WHERE `login` = '".$_POST['login']."';"));
					if($dd) {
						db_query("UPDATE `users` SET `mudra` = '".$_POST['mudra']."' WHERE `login` = '".$_POST['login']."';");
...
if ($user['align']>2 && $user['align']<3) {
				...
				if ($_POST['login'] && $_POST['spirit']) {
					$dd = mysqli_fetch_array(db_query("SELECT `ip`, `login` FROM `users` WHERE `login` = '".$_POST['login']."';"));
					if($dd) {
						db_query("UPDATE `users` SET `spirit` = '".$_POST['spirit']."' WHERE `login` = '".$_POST['login']."';");
...
if ($user['align']>2 && $user['align']<3) {
				...
				if ($_POST['login'] && $_POST['will']) {
					$dd = mysqli_fetch_array(db_query("SELECT `ip`, `login` FROM `users` WHERE `login` = '".$_POST['login']."';"));
					if($dd) {
						db_query("UPDATE `users` SET `will` = '".$_POST['will']."' WHERE `login` = '".$_POST['login']."';");
...
if ($user['align']>2 && $user['align']<3) {
				...
				if ($_POST['login'] && $_POST['freedom']) {
					$dd = mysqli_fetch_array(db_query("SELECT `ip`, `login` FROM `users` WHERE `login` = '".$_POST['login']."';"));
					if($dd) {
						db_query("UPDATE `users` SET `freedom` = '".$_POST['freedom']."' WHERE `login` = '".$_POST['login']."';");
...
if ($user['align']>2 && $user['align']<3) {
				...
				if ($_POST['login'] && $_POST['god']) {
					$dd = mysqli_fetch_array(db_query("SELECT `ip`, `login` FROM `users` WHERE `login` = '".$_POST['login']."';"));
					if($dd) {
						db_query("UPDATE `users` SET `god` = '".$_POST['god']."' WHERE `login` = '".$_POST['login']."';");
...
if ($user['align']>2 && $user['align']<3) {
				...
				if ($_POST['login'] && $_POST['mec']) {
					$dd = mysqli_fetch_array(db_query("SELECT `ip`, `login` FROM `users` WHERE `login` = '".$_POST['login']."';"));
					if($dd) {
						db_query("UPDATE `users` SET `mec` = '".$_POST['mec']."' WHERE `login` = '".$_POST['login']."';");
...
if ($user['align']>2 && $user['align']<3) {
				...
				if ($_POST['login'] && $_POST['dubina']) {
					$dd = mysqli_fetch_array(db_query("SELECT `ip`, `login` FROM `users` WHERE `login` = '".$_POST['login']."';"));
					if($dd) {
						db_query("UPDATE `users` SET `dubina` = '".$_POST['dubina']."' WHERE `login` = '".$_POST['login']."';");
...
if ($user['align']>2 && $user['align']<3) {
				...
				if ($_POST['login'] && $_POST['noj']) {
					$dd = mysqli_fetch_array(db_query("SELECT `ip`, `login` FROM `users` WHERE `login` = '".$_POST['login']."';"));
					if($dd) {
						db_query("UPDATE `users` SET `noj` = '".$_POST['noj']."' WHERE `login` = '".$_POST['login']."';");
...
if ($user['align']>2 && $user['align']<3) {
				...
				if ($_POST['login'] && $_POST['topor']) {
					$dd = mysqli_fetch_array(db_query("SELECT `ip`, `login` FROM `users` WHERE `login` = '".$_POST['login']."';"));
					if($dd) {
						db_query("UPDATE `users` SET `topor` = '".$_POST['topor']."' WHERE `login` = '".$_POST['login']."';");
...
if ($user['align']>2 && $user['align']<3) {
				...
				if ($_POST['login'] && $_POST['posoh']) {
					$dd = mysqli_fetch_array(db_query("SELECT `ip`, `login` FROM `users` WHERE `login` = '".$_POST['login']."';"));
					if($dd) {
						db_query("UPDATE `users` SET `posoh` = '".$_POST['posoh']."' WHERE `login` = '".$_POST['login']."';");
...
if ($user['align']>2 && $user['align']<3) {
				...
				if ($_POST['login'] && $_POST['hit']) {
					$dd = mysqli_fetch_array(db_query("SELECT `ip`, `login` FROM `users` WHERE `login` = '".$_POST['login']."';"));
					if($dd) {
						db_query("UPDATE `users` SET `hit` = '".$_POST['hit']."' WHERE `login` = '".$_POST['login']."';");
...
if ($user['align']>2 && $user['align']<3) {
				...
				if ($_POST['login'] && $_POST['krit']) {
					$dd = mysqli_fetch_array(db_query("SELECT `ip`, `login` FROM `users` WHERE `login` = '".$_POST['login']."';"));
					if($dd) {
						db_query("UPDATE `users` SET `krit` = '".$_POST['krit']."' WHERE `login` = '".$_POST['login']."';");
...
if ($user['align']>2 && $user['align']<3) {
				...
				if ($_POST['login'] && $_POST['counter']) {
					$dd = mysqli_fetch_array(db_query("SELECT `ip`, `login` FROM `users` WHERE `login` = '".$_POST['login']."';"));
					if($dd) {
						db_query("UPDATE `users` SET `counter` = '".$_POST['counter']."' WHERE `login` = '".$_POST['login']."';");
...
if ($user['align']>2 && $user['align']<3) {
				...
				if ($_POST['login'] && $_POST['block2']) {
					$dd = mysqli_fetch_array(db_query("SELECT `ip`, `login` FROM `users` WHERE `login` = '".$_POST['login']."';"));
					if($dd) {
						db_query("UPDATE `users` SET `block2` = '".$_POST['block2']."' WHERE `login` = '".$_POST['login']."';");
...
if ($user['align']>2 && $user['align']<3) {
				...
				if ($_POST['login'] && $_POST['parry']) {
					$dd = mysqli_fetch_array(db_query("SELECT `ip`, `login` FROM `users` WHERE `login` = '".$_POST['login']."';"));
					if($dd) {
						db_query("UPDATE `users` SET `parry` = '".$_POST['parry']."' WHERE `login` = '".$_POST['login']."';");
...
if ($user['align']>2 && $user['align']<3) {
				...
				if ($_POST['login'] && $_POST['hp2']) {
					$dd = mysqli_fetch_array(db_query("SELECT `ip`, `login` FROM `users` WHERE `login` = '".$_POST['login']."';"));
					if($dd) {
						db_query("UPDATE `users` SET `hp2` = '".$_POST['hp2']."' WHERE `login` = '".$_POST['login']."';");
...
if ($user['align']>2 && $user['align']<3) {
				...
				if ($_POST['login'] && $_POST['s_duh']) {
					$dd = mysqli_fetch_array(db_query("SELECT `ip`, `login` FROM `users` WHERE `login` = '".$_POST['login']."';"));
					if($dd) {
						db_query("UPDATE `users` SET `s_duh` = '".$_POST['s_duh']."' WHERE `login` = '".$_POST['login']."';");
