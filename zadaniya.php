...
<? if($user['ed']>='5000'){?>
<INPUT type='button' value='Купить' onClick="if (confirm('Купить: Умение?\n\nУмение даёт возможность почуствовать себя мастером меча, топора, магии и т.п.')) {location='zadaniya.php?buy=master'}">
<? }else{ ?>
...
<? if($user['ed']>='100'){?>
<INPUT type='button' value='Купить' onClick="if (confirm('Купить: Деньги (10 кр.)?\n\nНаграду можно получить полновесными кредитами.')) {location='zadaniya.php?buy=kr'}">
<? }else{ ?>
...
<? if($user['ed']>='3000'){?>
<INPUT type='button' value='Купить'onclick="if (confirm('Купить: Опыт?\n\nОсобенность - это дополнительные опыт для персонажа.')) {location='zadaniya.php?buy=opit'}">
<? }else{ ?>
