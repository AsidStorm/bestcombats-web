...
<i>С глубоким уважением к Вам, Администрация проекта.</i>";
	...
	db_query("INSERT INTO `inventory` (`owner`,`name`,`type`,`massa`,`cost`,`img`,`maxdur`,`isrep`,`magic`,`present`)VALUES('".$_SESSION['uid']."', 'Мудрость Веков ', '25', '1', '0.00', 'spell_godstat_wis.gif', '1', '0', '171', 'Администрация') ;");
	...
	db_query("INSERT INTO `inventory` (`owner`,`name`,`type`,`massa`,`cost`,`img`,`maxdur`,`isrep`,`magic`,`present`)VALUES('".$_SESSION['uid']."', 'Восстановление энергии 1500HP', '25', '1', '0.00', 'cureHP1500_100.gif', '5', '0', '9', 'Администрация') ;");
        ...
        db_query("INSERT INTO `inventory` (`owner`,`name`,`type`,`massa`,`cost`,`img`,`maxdur`,`isrep`,`magic`,`present`)VALUES('".$_SESSION['uid']."', 'Ледяной интеллект', '25', '1', '0.00', 'spell_godstat_intel.gif', '1', '0', '171', 'Администрация') ;");
        ...
        db_query("INSERT INTO `inventory` (`owner`,`name`,`type`,`massa`,`cost`,`img`,`maxdur`,`isrep`,`magic`,`present`)VALUES('".$_SESSION['uid']."', 'Нападение', '25', '1', '0.00', 'attack.gif', '5', '0', '23', 'Администрация') ;");
         ...
         db_query("INSERT INTO `inventory` (`owner`,`name`,`type`,`massa`,`cost`,`img`,`maxdur`,`isrep`,`magic`,`present`)VALUES('".$_SESSION['uid']."', 'Кровавое нападение', '25', '1', '0.00', 'attackb.gif', '2', '0', '45', 'Администрация') ;");
