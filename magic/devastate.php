...
$effect = mysqli_fetch_array(db_query("SELECT `time` FROM `effects` WHERE `owner` = '{$us['id']}' and `type` = '202' LIMIT 1;"));
...
elseif (rand(1,100) < $int) {
      ...
      db_query("INSERT INTO `effects` (`owner`,`name`,`time`,`type`,caster) values ('$us[id]','Сокрушение',".(time()+7200).",202,'$user[id]');");
