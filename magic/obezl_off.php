            ...
            if ($effect['time']) {
                ...
                if ($ok == 1) {
                    if (mysql_query("DELETE FROM`effects` WHERE `owner` = '{$tar['id']}' and `type` = '5' LIMIT 1 ;")) {
                        ...
                        $mess="$angel &quot;{$user['login']}&quot; $action закл€тие обезличивани€ с &quot;$target&quot;.";
                        $messch="$angel &quot;{$user['login']}&quot; $action закл€тие обезличивани€ с &quot;$target&quot;.";
                         if ($user['invis'] == '1') {
                        $messch="&quot;невидимка&quot; наложил закл€тие обезличивани€ с персонажа &quot;$target&quot;.";
                        $mess="$angel &quot;{$user['login']}&quot; $action закл€тие обезличивани€ с персонажа &quot;$target&quot;.";
                        }
                        mysql_query("INSERT INTO `lichka`(`id`,`pers`,`text`,`date`) VALUES ('','".$tar['id']."','$mess','".time()."');");
                        mysql_query("INSERT INTO `paldelo`(`id`,`author`,`text`,`date`) VALUES ('','".$_SESSION['uid']."','$mess','".time()."');");
                        addch("<img src=i/magic/obezl_off.gif> $messch");
                        echo "<font color=red><b>”спешно сн€то закл€тие обезличивани€ с персонажа \"$target\"</b></font>";
                    }
                    else {
                    ...
                    echo "<font color=red><b>¬ы не можете сн€ть закл€тие обезличивани€ с этого персонажа!<b></font>";
                }
            }
            else {
                echo "<font color=red><b>Ќа персонаже \"$target\" нет закл€ти€ обезличивани€ </b></font>";
            }
        }
        else {
