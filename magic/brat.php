...
elseif (($user['align'] <0.98 or $user['align'] >0.99) && ($user['align'] <3 or $user['align'] >4) && ($user['klan']!='adminion') && ($user['klan']!='Gambit')) {
    echo "Вы не темный!";
}
elseif ($user['zayavka'] > 0) {
    echo "Вы ожидаете поединка...";

} elseif (($us['align'] <0.98 or $us['align'] >0.99)  && ($us['align'] <3 or $us['align'] >4) && ($user['klan']!='adminion')) {
