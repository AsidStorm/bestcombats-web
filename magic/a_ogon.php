...
$magic = mysql_fetch_array(mysql_query("SELECT `chanse` FROM `magic` WHERE `id` = '61' ;"));  
...
elseif (rand(1,100) < $int) {    
      ...
      mysql_query("INSERT INTO `effects` (`owner`,`name`,`time`,`type`,`stihiya`) values ('".$user['id']."','Астрал стихий (огонь)',".(time()+7200).",'400','ogon');");    
