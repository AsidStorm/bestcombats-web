...
if ($cant) {
  ...
  takefromzayavka($us["id"]);
            ...
            if($jert['id']!=$user['id']) {
                if ($user['invis']==1) {
                addch("<img src=i/magic/attackt.gif> <B>невидимка</B>, применив магию темного нападения, внезапно ".$action." на &quot;{$_POST['target']}&quot;");
                ...
                addch("<img src=i/magic/attackt.gif> <B>{$user['login']}</B>, применив магию темного нападения, внезапно ".$action." на &quot;{$_POST['target']}&quot;");
