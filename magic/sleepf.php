...
$coma[] = "Повышаем, повышаем уровень грамотности";
        ...
        if ($tar['id']) {
            ...
            if ($effect['time']) {
                ...
                if ($ok == 1) {
                    if (db_query("INSERT INTO `effects` (`owner`,`name`,`time`,`type`) values ('".$tar['id']."','Заклятие форумного молчания','$magictime',3);")) {
                        $ldtarget=$target;
                        ...
                        if ($user['invis'] == '1') {
                        $mess="$angel &quot;{$user['login']}&quot; $action заклятие форумного молчания на персонажа &quot;$target&quot; сроком $magictime";
                        $messch="&quot;невидимка&quot; наложил заклятие форумного молчания на персонажа &quot;$target&quot; сроком $magictime";
                        }
