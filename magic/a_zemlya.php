...
$magic = mysqli_fetch_array(db_query("SELECT `chanse` FROM `magic` WHERE `id` = '64' ;"));
...
elseif (rand(1,100) < $int) {    
      ...
      db_query("INSERT INTO `effects` (`owner`,`name`,`time`,`type`,`stihiya`) values ('".$user['id']."','Астрал стихий (земля)',".(time()+7200).",'400','zemlya');");
