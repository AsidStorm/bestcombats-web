...
<body style="margin:10px; margin-top:5px; background-image: url(<?=IMG_PATH?>/klan/<?=$klan['clanbig']?>.gif); background-repeat:no-repeat; background-position: top right" bgcolor=e2e0e0>
<table width="100%" cellpadding=0 cellspacing=0 border=0>
<?if ($klan['guard']==1) {?>
<tr><td colspan=2 align=center>Информация о клане <img src="<?=IMG_PATH?>/clans/guard.gif" alt="Гвардейский клан"> "<b><?=$klan['name']?></b>"</td></tr>
<?}else{?>
...
<td width="50%">
Знак клана: <img src="<?=IMG_PATH?>/klan/<?=$klan['short']?>.gif"> Склонность: <img src="<?=IMG_PATH?>/align/align_<?=$klan['align']?>.gif">
</td>
</tr>
<tr>
