...
if($_POST['magaz']==1){
	...
	if (db_query("insert into shop (name,duration,maxdur,cost,type,massa,razdel,count,img,koll) values ('".$_POST['recept']."','0','1','".$_POST['ecost']."','200','0.1','52','50000','etc_recipe_blue_i00.png','1');")) 	{
	echo "OK";
	}
else { echo "NO";} 
	...
	if (db_query("insert into berezka (name,duration,maxdur,ecost,type,massa,razdel,count,img,koll) values ('".$_POST['recept']."','0','1','".$_POST['ecost']."','200','0.1','52','50000','etc_recipe_blue_i00.png','1');")) 	{
	echo "OK";
	}
else { echo "NO";} 
