...
<tr><td>Магазин по городу
	</td><td><select name="magazin">
			<option value="shop_old">Кэпитал</option>
			<option value="shop">Емеральд</option>
	        </select> </td></tr>
			
<tr><td>Название </td><td><input type=text name=name value=''> </td></tr>
<tr><td>Картинка </td><td><input type=text name=img></td></tr>
...
<tr><td>Раздел магазина 
			...
			<option value="15">Оружие: Магические Посохи</option>
			<option value="2">Одежда: сапоги</option>
			<option value="21">Одежда: перчатки</option>
			<option value="200">Одежда: Рубахи</option>
			...
			<option value="231">Одежда: плащи</option>
			...
			<option value="54">Исцеляющие</option>
			<option value="55">Манящие</option>
			<option value="56">Стратегические</option>
			<option value="57">Тактические</option>
			<option value="300">Усиления Оружия</option>
			<option value="6">Амуниция</option>
			<option value="188">Эликсиры</option>
			<option value="7">Сувениры: открытки</option>
			<option value="71">Сувениры: подарки</option>
			<option value="50">Еда</option>
                        <option value="777">Свадебный Отдел</option>
	</select> </td></tr>
...
<tr><td>Макс.износ  </td><td><input type=text name=maxdur  value="30"></td></tr>
<tr><td>Цена  </td><td><input type=text name=cost  value="0"></td></tr>
</table>
<b>Требования:</b>
<table>
<tr><td>Уровень  </td><td><input type=text name=nlevel  value="7"></td></tr>
