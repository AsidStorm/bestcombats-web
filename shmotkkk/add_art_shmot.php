...
<tr><td>Связан судьбой </td><td><input type=text name=destiny value="1"></td></tr>
...
<tr><td>Тип предмета 
			...
			<option value="25">Заклинания или книги</option>
			<option value="200">Прочее(подарки)</option>
	</select> </td></tr>

<tr><td>Масса </td><td><input type=text name=massa value="1"> </td></tr>
...
<tr><td>Раздел магазина 
			...
			<option value="15">Оружие: посохи</option>
			...
			<option value="555">Руны</option>
			<option value="111">Книги воздуха</option>
			<option value="222">Книги вода</option>
			<option value="333">Книги земля</option>
			<option value="444">Книги огонь</option>
	</select> </td></tr>
...
<tr><td>Макс.износ  </td><td><input type=text name=maxdur  value="1"></td></tr>
<tr><td>Цена Екр </td><td><input type=text name=ecost  value="0"></td></tr>
</table>
<b>Требования:</b>
<table>
...
<tr><td>Мф. Мощ. Стихий </td><td><input type=text name=mfmagp  value="0"></td></tr>
...
<tr><td>Мощность колючего урона</td><td><input type=text name=mfkol  value="0"></td></tr>
<tr><td>Мощность рубящего урона</td><td><input type=text name=mfrub  value="0"></td></tr>
<tr><td>Мощность дробящего урона</td><td><input type=text name=mfdrob  value="0"></td></tr>
<tr><td>Мощность режущего урона</td><td><input type=text name=mfrej  value="0"></td></tr>
...
<tr><td>Подавление магии </td><td><input type=text name=mfpodav  value="0"></td></tr>
<tr><td>Статы </td><td><input type=text name=add_stats  value="0"></td></tr>
