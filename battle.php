...
if ((user == null)||(user == "")) {
    ...
    '<frameset rows="37, *, 30, 5" FRAMEBORDER="0" BORDER="0" FRAMESPACING="0">'+
        ...
        '<frameset cols="9, *, 9" FRAMEBORDER="0" BORDER="0" FRAMESPACING="0">'+
            '<frame src="left.php" target="_top" scrolling=NO NORESIZE FRAMEBORDER="0" BORDER="0" FRAMESPACING="0" MARGINWIDTH="0" MARGINHEIGHT="0">'+
            '<frameset rows="62%, *, 0" FRAMEBORDER="1" BORDER="0" FRAMESPACING="0" id="chatset">'+
            ...
            '</frameset>'+
            '<frame src="right.php" target="_top" scrolling=NO NORESIZE FRAMEBORDER="0" BORDER="0" FRAMESPACING="0" MARGINWIDTH="0" MARGINHEIGHT="0">'+
        '</frameset>'+
        '<frame name="bottom" scrolling="no" noresize src="buttons.php?'+rnd+'">'+
        '<frame src="bottom.php" target="_top" scrolling=NO NORESIZE FRAMEBORDER="0" BORDER="0" FRAMESPACING="0" MARGINWIDTH="0" MARGINHEIGHT="0">'+
    '</frameset>');
    ...
    '<frameset rows="37, *, 30, 5" FRAMEBORDER="0" BORDER="0" FRAMESPACING="0">'+
        ...
        '<frameset cols="9, *, 9" FRAMEBORDER="0" BORDER="0" FRAMESPACING="0">'+
            '<frame src="left.php" target="_top" scrolling=NO NORESIZE FRAMEBORDER="0" BORDER="0" FRAMESPACING="0" MARGINWIDTH="0" MARGINHEIGHT="0">'+
            '<frameset rows="58%, *, 0" FRAMEBORDER="1" BORDER="1" FRAMESPACING="0" id="chatset">'+
                '<frame name="main" src="main.php?top='+rnd+'" style="border-bottom-width: 2px; border-bottom-style:solid; border-bottom-color:#B0B0B0">'+
                '<frameset cols="*,220">'+
                    '<frame name="chat" src="buttons.php?ch='+rnd+'" target="_top" scrolling=YES FRAMEBORDER="0" BORDER="0" FRAMESPACING="0" MARGINWIDTH="3" MARGINHEIGHT="3">'+
                    '<frame name="online" src="ch.php?online='+rnd+'" target="_blank" scrolling=YES FRAMEBORDER=0 BORDER=0 FRAMESPACING=0 MARGINWIDTH=3 MARGINHEIGHT=0>'+
