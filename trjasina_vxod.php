...
<body bgcolor=e2e0e0 style="background-image: url(http://also.bestcombats.net/i/misc/trjasina.png);background-repeat:no-repeat;background-position:top right"> 
...
<!--FORM action="city.php" method=GET>
    <center>
        ...
        <a href = "http://also.bestcombats.net/i/map.gif" target="_blank">Карта Прохода</a>
    </center>
</FORM-->
<!--TABLE width=100%>
    <tr>
