...
<img src="i/vip1.gif" width=60 height=30 style="float: left; clear: none;" />
Стоимость:<br> 
На неделю - 15$ (150 екр)<br> 
На месяц - 35$ (350 екр)<br> 
На постоянную основу - 100$ (1000 екр)<br> 
------------------------------------------------------------<br><br>
<b>Gold аккаунт:</b><p>
<img src="i/vip2.gif" width=60 height=30 style="float: left; clear: none;" />
Стоимость:<br> 
На неделю - 10$ (100 екр)<br> 
На месяц - 25$ (250 екр)<br> 
На постоянную основу - 80$ (800 екр)<br> 
------------------------------------------------------------<br><br>
<b>Silver аккаунт:</b><p>
<img src="i/vip3.gif" width=60 height=30 style="float: left; clear: none;" />
Стоимость:<br> 
На неделю - 5$ (50 екр)<br> 
На месяц - 15$ (150 екр)<br> 
На постоянную основу - 60$ (600 екр)<br> 
------------------------------------------------------------<br><br>
