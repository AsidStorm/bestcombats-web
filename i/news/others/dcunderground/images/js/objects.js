...
descr: 'Вы получите "Снадобье океанов"'
		},
		denyingFountain: {
name: 'Фонтан Стойкости',icon: imP11 + 'fountaindeny.gif', src: imP21 + 'well06.png',
descr: 'Можно наполнить пустую бутылку "Снадобьем Стойкости." Но не все так просто...Сначала разыщите и убейте <b>Дарьяну Корт</b>. Снадобье получают лишь четыре человека из команды.'
		},
		chest: {
name: 'Сундук',icon: imP11 + 'sunduk.gif',src: imP21 + 'smag_collect1.png',
descr: 'В сундуке можно найти: <b>Шепот гор, Кольца Мороза(мф), Сияющее Кольцо(мф), Кольца Горящего Взгляда,</b> свиток <b>Снять проеклятье,</b> а можете и ничего не найти...Сундук может "открыть" лишь один человек из команды.'
		},
		greatDenyingFountain: {
name: 'Фонтан Обновления',icon: imP11 + 'fountaindeny.gif', src: imP21 + 'well06.png',
descr: 'Можно получить <b>"Великое зелье Отрицания".</b> Помимо пустой бутылки, требуеться драгоценный камень. Могут набрать два человека из команды...Но не все так просто, вначале убейте всех монстров в логове.'
		},
		plusFifteenFountain: {
name: 'Фонтан Зачарованных гор',icon: imP11 + 'fountain.gif', src: imP21 + 'fontan.png',
descr: 'Можно получить <b>"Снадобье Змеи", "Снадобье Великана", "Снадобье Предчувствия",</b> или <b>"Снадобье Разума".</b> Помимо пустой бутылки, требуется драгоценный камень. Могут набрать три члена команды. Для работы фонтана необходимо убить всех монстров в логове. '
		},
		lostMastersCupel: {
name: 'Разрушенная Мастерская забытых мастеров',icon: imP11 + 'lmc.gif',src: imP21 + 'well08.png',
descr: 'Используя ингредиенты, собраные в многочасовых странствиях по подземельям, в этой мастерской можно собрать множество полезных вещей. Создание предметов просходит с помощью диалогов.<br>Да, одна мелочь, для работы необходим <b>Мерцающий ключ №3.</b> Поищите его на клетке <b>E5.</b><br>Можно создать:</br><b>Черная метка</br>Красная метка</br>Свиток Умирающей Земли</br>Свиток Стихающего Ветра</br>Свиток Замерзающей Воды</br>Свиток Угасающего Огня</br>Свиток Легкого Отупления<br>Прокляте Уязвимости</b></br>'
		},
...
descr: ' В этом фонтане вы можете проапгрейдить Кольцо Алтаря до Мистического Кольца Алтаря, <a href="http://www.darkclan.ru/cgi/lib.pl?p=altar" target="_blank" class="TLink"><font color="#0000FF">подробности</font></a>. '
		},
		ghostPowerFountain: {
name: 'Фонтан Призрачной силы',icon: imP11 + 'fountainintel2.gif', src: imP21 + 'well02.png',                                                      
descr: ' В этом фонтане вы можете проапгрейдить Кольцо Алтаря до Воинского Кольца Алтаря, <a href="http://www.darkclan.ru/cgi/lib.pl?p=altar" target="_blank" class="TLink"><font color="#0000FF">подробности</font></a>.'
		},
		antidotFountain: {
name: 'Купель',icon: imP11 + 'fountainintel.gif', src: imP21 + 'chalice01.png',
...
svche: {
name: 'Черный светляк', icon: imP11 + 'svche.gif', src: imP21 + 'dec_torch02w.png',
