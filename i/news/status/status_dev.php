...
<?
	echo "<left><img src='http://img.combats.com/i/city/gerb/4.gif'></left>";
	
$online = mysql_query("select * from `online`  WHERE `real_time` >= ".(time()-60)." and `city`='devilscity';");
?>
<br><br><b>Devils City</b><br>
