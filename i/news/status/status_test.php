...
<?
	echo "<left><img src='http://wiki.combats.me/images/7/79/Gerb9.gif'></left>";
	
$online = mysql_query("select * from `online`  WHERE `real_time` >= ".(time()-60)." and `city`='test';");
?>
<br><br><b>East city </b><i>(Тестовый город)</i><br>
