...
<?
	echo "<left><img src='http://img.combats.com/i/city/gerb/8.gif'></left>";
	
$online = mysql_query("select * from `online`  WHERE `real_time` >= ".(time()-60)." and `city`='mooncity';");
?>
<br><br><b>Moon City</b><br>
