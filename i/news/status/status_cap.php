...
<?
	echo "<left><img src='http://bestcombats.net/news/i/city/1.gif'></left>";
	
$online = mysql_query("select * from `online`  WHERE `real_time` >= ".(time()-60)." and `city`='virtcity';");
?>
<br><br><b>Capital City</b><br>
