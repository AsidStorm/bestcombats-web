...
<?
	echo "<left><img src='http://img.combats.com/i/city/gerb/5.gif'></left>";
	
$online = mysql_query("select * from `online`  WHERE `real_time` >= ".(time()-60)." and `city`='suncity';");
?>
<br><br><b>Sun City</b><br>
